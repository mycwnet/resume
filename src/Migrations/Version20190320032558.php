 ...
 */
final class Version20190320032558 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project_samples CHANGE user_id user_id INT DEFAULT NULL, CHANGE title title VARCHAR(255) NOT NULL, CHANGE link link VARCHAR(255) DEFAULT NULL, CHANGE project_image project_image VARCHAR(255) DEFAULT NULL, CHANGE sample_index sample_index VARCHAR(255) DEFAULT NULL');
