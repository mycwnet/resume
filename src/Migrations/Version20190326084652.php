 ...
 */
final class Version20190326084652 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project_samples ADD sindex VARCHAR(255) DEFAULT NULL, DROP sample_index, CHANGE user_id user_id INT DEFAULT NULL, CHANGE link link VARCHAR(255) DEFAULT NULL, CHANGE project_image project_image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project_history CHANGE user_id user_id INT DEFAULT NULL, CHANGE end end DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE project_samples ADD sample_index VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, DROP sindex, CHANGE user_id user_id INT DEFAULT NULL, CHANGE link link VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE project_image project_image VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
