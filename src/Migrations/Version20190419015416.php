 ...
 */
final class Version20190419015416 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE proficiencies (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, years INTEGER NOT NULL, percent INTEGER NOT NULL, icon VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_1386EAD6A76ED395 FOREIGN KEY (user_id) REFERENCES profile (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE icon_list (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, icon VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('DROP INDEX UNIQ_A5E2A5D7A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__configuration AS SELECT id, user_id, dateformat, background_image, color FROM configuration');
        $this->addSql('DROP TABLE configuration');
