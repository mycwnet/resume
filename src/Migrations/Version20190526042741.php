 ...
 */
final class Version20190526042741 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE project_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, start DATETIME NOT NULL, "end" DATETIME DEFAULT NULL, position VARCHAR(255) DEFAULT NULL COLLATE BINARY, skills VARCHAR(255) DEFAULT NULL COLLATE BINARY, description VARCHAR(1024) NOT NULL, CONSTRAINT FK_B1A47C2EA76ED395 FOREIGN KEY (user_id) REFERENCES profile (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE project_history');
        $this->addSql('CREATE TABLE project_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, position VARCHAR(255) DEFAULT NULL, skills VARCHAR(255) DEFAULT NULL, start DATETIME NOT NULL, "end" DATETIME DEFAULT NULL, description VARCHAR(400) NOT NULL COLLATE BINARY)');
