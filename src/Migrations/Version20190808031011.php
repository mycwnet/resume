 ...
 */
final class Version20190808031011 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cover_letter (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, "to" VARCHAR(255) DEFAULT NULL, letter CLOB DEFAULT NULL, PRIMARY KEY(id))');
