 ...
 */
final class Version20190623000202 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE configuration (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, site_title VARCHAR(255) DEFAULT NULL, dateformat VARCHAR(255) NOT NULL, background_image VARCHAR(255) NOT NULL, site_logo VARCHAR(255) DEFAULT NULL, favicon_image VARCHAR(255) DEFAULT NULL, color VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE profile (id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, linkedin VARCHAR(255) DEFAULT NULL, github VARCHAR(255) DEFAULT NULL, gitlab VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, background CLOB NOT NULL, summary VARCHAR(1024) DEFAULT NULL, PRIMARY KEY(id))');
