 ...
 */
final class Version20190307195904 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE configuration CHANGE user_id user_id INT DEFAULT NULL, CHANGE background_image background_image VARCHAR(255) NOT NULL');
