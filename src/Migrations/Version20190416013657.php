 ...
 */
final class Version20190416013657 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE icon_list (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "index" INTEGER DEFAULT NULL, icon VARCHAR(255) DEFAULT NULL)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1386EAD6A76ED395 ON proficiencies (user_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__configuration');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_A5E2A5D7A76ED395 ON configuration (user_id)');
        $this->addSql('DROP INDEX UNIQ_1386EAD6A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__proficiencies AS SELECT id, user_id, title, years, percent FROM proficiencies');
        $this->addSql('DROP TABLE proficiencies');
        $this->addSql('CREATE TABLE proficiencies (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, years INTEGER NOT NULL, percent INTEGER NOT NULL, icon VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO proficiencies (id, user_id, title, years, percent) SELECT id, user_id, title, years, percent FROM __temp__proficiencies');
        $this->addSql('DROP TABLE __temp__proficiencies');
