 ...
 */
final class Version20190308010134 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE project_samples (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, blurb LONGTEXT DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, project_image VARCHAR(255) DEFAULT NULL, INDEX IDX_8F8C5B12A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
