 ...
 */
final class Version20190515233234 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__project_history AS SELECT id, user_id, title, start, "end", description, position, skills FROM project_history');
        $this->addSql('DROP TABLE project_history');
        $this->addSql('CREATE TABLE project_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, start DATETIME NOT NULL, "end" DATETIME DEFAULT NULL, description VARCHAR(400) NOT NULL COLLATE BINARY, position VARCHAR(255) DEFAULT NULL COLLATE BINARY, skills VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_B1A47C2EA76ED395 FOREIGN KEY (user_id) REFERENCES profile (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO project_history (id, user_id, title, start, "end", description, position, skills) SELECT id, user_id, title, start, "end", description, position, skills FROM __temp__project_history');
        ...
        $this->addSql('CREATE TABLE project_samples (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, sampleindex VARCHAR(255) NOT NULL COLLATE BINARY, title VARCHAR(255) NOT NULL COLLATE BINARY, link VARCHAR(255) DEFAULT NULL COLLATE BINARY, blurb VARCHAR(255) DEFAULT NULL, project_image VARCHAR(255) NOT NULL, CONSTRAINT FK_8F8C5B12A76ED395 FOREIGN KEY (user_id) REFERENCES profile (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE project_history');
        $this->addSql('CREATE TABLE project_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, position VARCHAR(255) DEFAULT NULL, description VARCHAR(400) NOT NULL, skills VARCHAR(255) DEFAULT NULL, start DATETIME NOT NULL, "end" DATETIME DEFAULT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__project_samples AS SELECT id, user_id, sampleindex, title, blurb, link, project_image FROM project_samples');
        $this->addSql('DROP TABLE project_samples');
        $this->addSql('CREATE TABLE project_samples (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, sampleindex VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, link VARCHAR(255) DEFAULT NULL, blurb CLOB DEFAULT NULL COLLATE BINARY, project_image VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO project_samples (id, user_id, sampleindex, title, blurb, link, project_image) SELECT id, user_id, sampleindex, title, blurb, link, project_image FROM __temp__project_samples');
        $this->addSql('DROP TABLE __temp__project_samples');
        $this->addSql('CREATE INDEX IDX_8F8C5B12A76ED395 ON project_samples (user_id)');
    }
