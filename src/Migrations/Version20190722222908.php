 ...
 */
final class Version20190722222908 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__profile AS SELECT id, title, first_name, last_name, email, phone, image, background, summary, location, linkedin, github, gitlab FROM profile');
        ...
        $this->addSql('INSERT INTO profile (id, title, first_name, last_name, email, phone, image, background, summary, location, linkedin, github, gitlab) SELECT id, title, first_name, last_name, email, phone, image, background, summary, location, linkedin, github, gitlab FROM __temp__profile');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__proficiencies');
        $this->addSql('CREATE INDEX IDX_1386EAD6A76ED395 ON proficiencies (user_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__profile AS SELECT id, title, first_name, last_name, email, phone, location, linkedin, github, gitlab, image, background, summary FROM profile');
        $this->addSql('DROP TABLE profile');
        $this->addSql('CREATE TABLE profile (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, linkedin VARCHAR(255) DEFAULT NULL, github VARCHAR(255) DEFAULT NULL, gitlab VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, background CLOB NOT NULL, summary VARCHAR(1024) DEFAULT NULL)');
        $this->addSql('INSERT INTO profile (id, title, first_name, last_name, email, phone, location, linkedin, github, gitlab, image, background, summary) SELECT id, title, first_name, last_name, email, phone, location, linkedin, github, gitlab, image, background, summary FROM __temp__profile');
        $this->addSql('DROP TABLE __temp__profile');
        $this->addSql('DROP INDEX IDX_B1A47C2EA76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__project_history AS SELECT id, user_id, title, position, description, skills, start, "end" FROM project_history');
        $this->addSql('DROP TABLE project_history');
