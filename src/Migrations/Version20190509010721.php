 ...
 */
final class Version20190509010721 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__project_history AS SELECT id, user_id, title, start, "end", description FROM project_history');
        $this->addSql('DROP TABLE project_history');
        $this->addSql('CREATE TABLE project_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, start DATETIME NOT NULL, "end" DATETIME DEFAULT NULL, description VARCHAR(400) NOT NULL COLLATE BINARY, position VARCHAR(255) DEFAULT NULL, skills VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_B1A47C2EA76ED395 FOREIGN KEY (user_id) REFERENCES profile (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO project_history (id, user_id, title, start, "end", description) SELECT id, user_id, title, start, "end", description FROM __temp__project_history');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE project_history');
        $this->addSql('CREATE TABLE project_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(400) NOT NULL, start DATETIME NOT NULL, "end" DATETIME DEFAULT NULL)');
