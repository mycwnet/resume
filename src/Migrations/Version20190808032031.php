 ...
 */
final class Version20190808032031 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cover_letter (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, "to" VARCHAR(255) DEFAULT NULL COLLATE BINARY, letter CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_EBE6B47A76ED395 FOREIGN KEY (user_id) REFERENCES profile (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO cover_letter (id, user_id, "to", letter) SELECT id, user_id, "to", letter FROM __temp__cover_letter');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cover_letter AS SELECT id, user_id, "to", letter FROM cover_letter');
        $this->addSql('DROP TABLE cover_letter');
        $this->addSql('CREATE TABLE cover_letter (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, "to" VARCHAR(255) DEFAULT NULL, letter CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO cover_letter (id, user_id, "to", letter) SELECT id, user_id, "to", letter FROM __temp__cover_letter');
        $this->addSql('DROP TABLE __temp__cover_letter');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_EBE6B47A76ED395 ON cover_letter (user_id)');
        $this->addSql('DROP INDEX IDX_1386EAD6A76ED395');
