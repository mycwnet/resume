 ...
 */
final class Version20190418234259 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE proficiencies (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, years INTEGER NOT NULL, percent INTEGER NOT NULL, icon VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_1386EAD6A76ED395 FOREIGN KEY (user_id) REFERENCES profile (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__icon_list AS SELECT id, icon FROM icon_list');
        $this->addSql('DROP TABLE icon_list');
        $this->addSql('CREATE TABLE icon_list (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, icon VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO icon_list (id, icon) SELECT id, icon FROM __temp__icon_list');
        $this->addSql('DROP TABLE __temp__icon_list');
        $this->addSql('DROP INDEX IDX_1386EAD6A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__proficiencies AS SELECT id, user_id, title, years, percent FROM proficiencies');
