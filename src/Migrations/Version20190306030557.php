 ...
 */
final class Version20190306030557 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE configuration CHANGE user_id user_id INT DEFAULT NULL, CHANGE background_image background_image VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE proficiencies CHANGE user_id user_id INT DEFAULT NULL');
